 ...
 */
 class BufferedTokenStream implements TokenStream {
    ...
    @override
     TokenSource getTokenSource() { return tokenSource; }
	...
	@override
	 int LA(int i) { return LT(i).getType(); }
...
if (_types is int) {
		HashSet<int> s = new HashSet<int>(_types);
		s.add(_types);
...
Set<int> types = _types;
		...
		{
      throw new RangeError("start $start or stop $stop not in 0..${tokens.length - 1}");
		}

...
//			System.err.print("[SPURIOUS] ");
    ...
    if (e is NoViableAltException) {
      ...
      recognizer.notifyErrorListeners(e.offendingState, e.message, e);
    }
  }
...
//			System.err.println("FAILSAFE consumes "+recognizer.getTokenNames()[recognizer.inputStream.LA(1)]);
  ...
  void sync(Parser recognizer) {
    ATNState s = recognizer.interpreter.atn.states.get(recognizer.state);
...
//			System.err.println("at loop back: "+s.getClass().getSimpleName());
  ...
  void reportNoViableAlternative(Parser recognizer, NoViableAltException e) {
    ...
    String input;
    if (tokens != null) {
      if (e.getStartToken().type == Token.EOF)
        input = "<EOF>";
      else
  ...
  void reportInputMismatch(Parser recognizer, InputMismatchException e) {
    String msg = "mismatched input " +
        ...
        " expecting " +
        e.expectedTokens.toString(recognizer.vocabulary);
    recognizer.notifyErrorListeners(e.getOffendingToken(), msg, e);
  }
  ...
  void reportFailedPredicate(Parser recognizer, FailedPredicateException e) {
    String ruleName = recognizer.ruleNames[recognizer.ctx.ruleIndex];
  ...
  bool singleTokenInsertion(Parser recognizer) {
    ...
    ATNState currentState =
        recognizer.interpreter.atn.states.get(recognizer.state);
...
//		System.out.println("LT(2) set="+expectingAtLL2.toString(recognizer.getTokenNames()));
  ...
  Token getMissingSymbol(Parser recognizer) {
    ...
    return recognizer.tokenFactory.create(
        new Pair<TokenSource, CharStream>(
            current.tokenSource, current.tokenSource.inputStream),
        expectedTokenType,
        tokenText,
